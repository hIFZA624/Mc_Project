...
public class DetailUser extends AppCompatActivity {
    ...
    public void updateuser10(View view) {
        ...
        Boolean deletedRows=dbHelper.updateUSER(intent.getStringExtra("Username"),intent.getStringExtra("last"),intent.getStringExtra("email"),id2,intent.getStringExtra("password"));
        if(deletedRows==true)
